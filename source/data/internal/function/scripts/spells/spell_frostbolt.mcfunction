...
#EFFECTS
execute positioned ~ ~1 ~ run particle block{block_state:{Name:packed_ice}} ~ ~ ~ 0.0 0.0 0.0 0.1 1 normal @a
execute positioned ~ ~1 ~ run particle block{block_state:{Name:blue_ice}} ~ ~ ~ 0.1 0.1 0.1 0.1 1 normal @a
