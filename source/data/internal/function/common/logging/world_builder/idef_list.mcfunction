...
execute if score #log __event_idef matches 10000 run data modify storage log:world_builder event[-1].idef_name set value OP_INIT_AREA_TRIGGER
execute if score #log __event_idef matches 10001 run data modify storage log:world_builder event[-1].idef_name set value OP_ACTION_AREA_TRIGGER
