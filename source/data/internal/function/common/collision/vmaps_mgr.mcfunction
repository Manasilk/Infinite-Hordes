...
execute as @e[type=#internal:area_trigger,tag=ENTITY_FLAG_COLLISION_TRIGGER] at @s anchored eyes positioned ^ ^ ^ run function internal:common/collision/move_forward