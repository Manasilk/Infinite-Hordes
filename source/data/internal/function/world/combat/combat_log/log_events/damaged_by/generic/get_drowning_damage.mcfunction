advancement revoke @s only internal:world/combat_log/drowning_damage
...
tag @s[tag=!SPELL_AURA_GHOST,tag=player.combat_log_toggled] add combat_log.damage_type_drowning