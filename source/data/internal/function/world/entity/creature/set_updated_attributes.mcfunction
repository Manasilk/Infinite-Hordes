execute store result entity @s Attributes[{Name:"minecraft:max_health"}].Base double 0.001 run scoreboard players get #temp entity_maxhp
execute store result entity @s Attributes[{Name:"minecraft:attack_damage"}].Base double 0.001 run scoreboard players get #temp entity_curap
