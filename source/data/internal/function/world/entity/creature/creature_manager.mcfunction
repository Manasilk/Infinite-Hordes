#Tick
#scoreboard players add @s entity_tick 10
#scoreboard players set @s[scores={entity_tick=11..}] entity_tick 0
...
#execute unless score @s cfg.difficulty = #world cfg.difficulty run function internal:world/entity/creature/get_difficulty_changed
