...
execute store result entity @s Attributes[{Name:"minecraft:max_health"}].Base double 1 run scoreboard players get @s entity_basehp
execute store result entity @s Attributes[{Name:"minecraft:attack_damage"}].Base double 1 run scoreboard players get @s entity_baseap
