...
#execute if score @s rand matches 5 run function developer:world_builder/structure_data/badlands/replace_structure_data
#execute if score @s rand matches 6 run function developer:world_builder/structure_data/taiga/replace_structure_data