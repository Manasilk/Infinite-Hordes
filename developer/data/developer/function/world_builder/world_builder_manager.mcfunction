...
execute if score @s[predicate=developer:world_builder/world_builder_tool,scores={chat.opts_menu=0..}] chat.right_mouse matches 1.. run function developer:world_builder/on_right_mouse