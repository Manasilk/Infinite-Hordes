...
item replace entity @s[tag=account.builder,scores={chat.return=1..}] hotbar.0 with minecraft:carrot_on_a_stick[minecraft:custom_data={world_builder_tool:1b},minecraft:custom_name='{"translate":"item.assist_tool","italic":false}']
